...
namespace DG110117Upp4
{
    public class Plane2
    {
        ...
        private Vector3 translation = new Vector3(-3, 0, 0);
        ...
        public Plane2(GraphicsDevice graphicsDevice)
        {
        ...
        {
            this.objectWorld *= Matrix.CreateRotationX(MathHelper.PiOver4 / 20) * Matrix.CreateRotationZ(MathHelper.PiOver4/50);
        }
        ...
        public void Draw(GameTime gametime, BasicEffect effect)
        {
            ...
            graphics.Indices = ib;
            objectWorld.Translation = translation;
